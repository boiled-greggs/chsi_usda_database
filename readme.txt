...
If it doesn't work at all, included is an html file that shows what those maps create.
...
Just open it in your favorite web-browser to see another example of how the user can explore the data.
...
of 29example choropleths created by the application on our machines. Some of them are pretty interesting.
